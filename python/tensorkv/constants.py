"""Paper-derived constants for TensorKV.

Source: TensorKV: A Semantic-Aware In-Network KV Cache for Long-Context LLM Inference.
"""
...
# Llama-3-70B, KIVI-style INT4 KV: 81.9 KB per token (paper Figure 1 / methodology).
...
# Default Zipfian access (paper Section 4 / microbenchmarks).
ZIPF_ALPHA = 1.2

# Paper-reported end-to-end numbers (A100, 32K prefix / 1.0 GB decode step).
PAPER_TTFT_MS = {
