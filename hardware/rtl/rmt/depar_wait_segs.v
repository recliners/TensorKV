...
(
	...
	(* mark_debug = "true", keep = "true" *) input												pkt_fifo_empty,
	(* mark_debug = "true", keep = "true" *) input												fst_half_fifo_ready,
	(* mark_debug = "true", keep = "true" *) input												snd_half_fifo_ready,

	// output
	(* mark_debug = "true", keep = "true" *) output reg											pkt_fifo_rd_en,
	...
	(* mark_debug = "true", keep = "true" *) output reg											fst_half_valid,
	...
	(* mark_debug = "true", keep = "true" *) output reg											snd_half_valid,
...
(* mark_debug = "true", keep = "true" *) reg [2:0] state, state_next;
